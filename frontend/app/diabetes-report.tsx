...
export default function DiabetesReportScreen() {
    ...
    const predictionExplanation = report.explanation || getFallbackExplanation(report.predicted_type);
                    ...
                    {report.cluster_stats && (
                        <>
                            ...
                            <View style={styles.detailBlock}>
                                ...
                                <Text style={styles.statsText}>- Mean BMI: {report.cluster_stats.mean_BMI.toFixed(1)}</Text>
                                <Text style={styles.statsText}>- Mean Age: {report.cluster_stats.mean_Age.toFixed(1)}</Text>
                            </View>
                        </>
                    )}
